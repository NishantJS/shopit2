    ...
    <div class="row">
        ...
        <div class="row border-top py-3 mt-3">
          ...
          <div class="col-sm-8">
            ...
            <div class="d-flex">
              ...
              <a href="#" class="px-2 font-rale font-size-14 badge badge-info">2,132 ratings</a>
            </div>
            ...
            <div class="qty d-flex pt-2">
              ...
              <form method="post">
                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                <button type="submit" name="wishlist-submit" class="btn font-baloo text-success">Save for Later</button>
              </form>
      ...
      <div class="col-sm-3">
        <div class="sub-total border text-center mt-2">
          <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check"></i> Your order is eligible for
            FREE Delivery.</h6>
